...
Support for Oneplus 3T and LeEco Le Pro3 (02/16/2022)
...
By default, openpilot uploads the driving data to our servers. You can also access your data through [comma connect](https://api.retropilot.org/). We use your data to train better models and improve openpilot for everyone.
